class departmentsData {
  ...
  departmentsData({this.departments, this.projects});

  departmentsData.fromJson(Map<String, dynamic> json) {
...
// 
//   Projects.fromJson(Map<String, dynamic> json) {
//     projectA = json['projectA'] != null
//         ? new ProjectA.fromJson(json['projectA'])
//         : null;
//     projectB = json['projectB'] != null
//         ? new ProjectA.fromJson(json['projectB'])
//         : null;
//     projectC = json['projectC'] != null
//         ? new ProjectA.fromJson(json['projectC'])
//         : null;
//     projectD = json['projectD'] != null
